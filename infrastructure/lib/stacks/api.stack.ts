...
export class ApiStack extends Stack {
  ...
  constructor(scope: Construct, id: string, props: ApiStackProps) {
    ...
    for (const [method, path] of [
      ...
      [HttpMethod.GET, '/tenants/{tenantId}/uncertain'],
      [HttpMethod.POST, '/tenants/{tenantId}/uncertain/{rawTransactionId}/confirm'],
      [HttpMethod.POST, '/tenants/{tenantId}/uncertain/{rawTransactionId}/discard'],
